        ...
        <Card elevation={3} sx={{ p: 2 }}>
          <ContentBox>
            <FabIcon size="medium" sx={{ background: "#1976d24c" }}>
              <Inventory2OutlinedIcon color="#222A45" />
            </FabIcon>

            <H3 color="#08ad6c">Total Inbound</H3>
          </ContentBox>
          ...
          <ContentBox sx={{ pt: 2 }}>
            ...
            <Span color="#08ad6c">37248kg</Span>
          </ContentBox>
        </Card>
      </Grid>
      ...
      <Grid size={{ md: 6, xs: 12 }}>
        <Card elevation={3} sx={{ p: 2 }}>
          <ContentBox>
            ...
            <H3 color="error.main">Total Outbound</H3>
          </ContentBox>

          <ContentBox sx={{ pt: 2 }}>
            <H1>81</H1>
            <Span color="error.main">22319kg</Span>
          </ContentBox>
        </Card>
      </Grid>
    </Grid>
