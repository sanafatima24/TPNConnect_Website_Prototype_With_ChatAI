        ...
        <Grid container>
          <Grid size={{ md: 6, xs: 12 }}>
            <div className="cardLeft">
              <Logo>
                <MatxLogo /> <span>TPN Connect</span>
              </Logo>

              <h1 className="mainTitle">The Pallet Network</h1>

              <div className="features">
                <div className="item">Instant Depot-to-Depot Communication</div>
                <div className="item">AI-Assistance for Issue Reporting and Communication</div>
                <div className="item">A Cleaner, Simpler Dashboard</div>
              </div>
              ...
              <Box display="flex" justifyContent="center" mt={3}>
                <Button
                  ...
                  onClick={() => navigate("/")} // Or any route or action
                >
                  Track and Trace
                </Button>
              </Box>
